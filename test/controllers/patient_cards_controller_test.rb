...
class PatientCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create patient_card" do
    assert_difference("PatientCard.count") do
      post patient_cards_url, params: { patient_card: { department_id: @patient_card.department_id, doctor_id: @patient_card.doctor_id, patient_id: @patient_card.patient_id } }
    end
  ...
  test "should update patient_card" do
    patch patient_card_url(@patient_card), params: { patient_card: { department_id: @patient_card.department_id, doctor_id: @patient_card.doctor_id, patient_id: @patient_card.patient_id } }
